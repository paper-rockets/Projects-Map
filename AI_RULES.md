...
- You work ONLY inside this exact folder:
  C:\Users\macie\OneDrive\Desktop\Mind
...
- Any time you mention a folder or file location, write the COMPLETE path from the drive letter onward, exactly as it is, so I can copy and paste it. For example: C:\Users\macie\Desktop\mindmap
...
- Every time you finish a task, end your message with TWO confirmations:
    1. The FULL folder path you applied the change to (complete, copy-paste ready), so I can see it landed in the right place. For example: C:\Users\macie\Desktop\mindmap
